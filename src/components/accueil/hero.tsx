    ...
    return (
        <>
            <section className="overflow-x-hidden relative z-0 px-[150px] bg-red-2 h-screen w-screen flex items-center justify-between overflow-hidden max-2xl:px-[100px] max-xl:h-[70vh] max-xl:px-[60px] max-[896px]:hidden">
                <div className="w-3/5 flex flex-col items-start justify-start gap-4">
                    <h1 className="text-6xl font-bold text-left text-gris-12 max-xl:text-5xl max-lg:text-4xl">Composez votre kit beauté sur-mesure</h1>
                    <p className="hero-p text-left text-gris-12 w-full max-xl:text-lg">
                ...
                <div className="absolute -left-20 -bottom-20 -z-10 flex items-center justify-center size-68 max-xl:size-48 max-xl:-bottom-10">
                    <Image src={"/deco_1.png"} fill alt="deco-1"/>
                </div>
                <div className="absolute -left-10 top-14 -z-10 flex items-center justify-center w-48 h-44 rotate-[100deg] max-xl:w-36 max-xl:h-28 max-xl:top-10">
                    <Image src={"/deco_4.png"} fill alt="deco-4"/>
                </div>
                <div className="-z-100 absolute right-2/5 top-10 flex items-center justify-center size-48 max-xl:size-36">
                    <Image src={"/deco_3.png"} fill alt="deco-3"/>
                </div>
                <div className="absolute left-96 bottom-56 -z-100 flex items-center justify-center size-16 max-xl:size-12">
                    <Image src={"/circle.svg"} fill alt="circle"/>
                </div>
                <div className="absolute left-[700px] bottom-4 -z-10 flex items-center justify-center size-16 max-xl:left-[500px] max-xl:size-12">
                    <Image src={"/star4.svg"} fill alt="star4"/>
                </div>
                <div className="absolute left-[600px] top-40 -z-10 flex items-center justify-center size-16 max-xl:size-12">
                    <Image src={"/flocon.svg"} fill alt="flocon"/>
                </div>
                <div className="absolute right-20 top-20 -z-10 flex items-center justify-center size-16 max-xl:size-12">
