    ...
    return (
        <>
            ...
            <div onClick={() => handleSidebarToglle()} className={`fixed z-50 h-screen w-screen bg-gris-12/60 transition-transform ease-in-out duration-300 hidden items-start justify-start max-[896px]:flex ${isClicked ? "translate-x-0" : "-translate-x-full"}`}>
                <div className="relative bg-red-1 overflow-auto w-1/2 h-full flex flex-col items-start justify-start gap-4 p-4 max-sm:w-2/3 max-xs:w-full">
                    ...
                    <div className="w-full flex flex-col items-start justify-between">
                        ...
                        <Link href={"/politique-de-confidentialite"} className="py-2 border-b border-gris-4 w-full text-gris-10 text-lg font-bold transition duration-200 ease-in hover:text-red-8 hover:border-red-8">Politique de confidentialité</Link>
                        <Link href={"/politique-de-retour"} className="py-2 border-b border-gris-4 w-full text-gris-10 text-lg font-bold transition duration-200 ease-in hover:text-red-8 hover:border-red-8">Politique de retour et remboursement</Link>
                    </div>              
                </div>
            </div>
            {
