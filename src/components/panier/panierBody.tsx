        ...
        <section className='overflow-x-hidden relative px-[150px] pt-32 py-6 w-screen h-screen flex flex-col items-center justify-start gap-4 max-2xl:px-[100px] max-xl:px-[60px] max-896:py-20  max-896:!px-4'>
            <div className="w-3/4 flex flex-col items-start justify-center gap-4 max-xl:w-4/5 max-lg:w-full">
                ...
                <div className="self-end border-t border-gris-6 pt-4 w-full flex flex-col items-end justify-start gap-4">
                    ...
                    <Link href={"/panier/verification"} className={`mt-2 rounded-full font-bold bg-red-8 w-1/2 flex items-center justify-center text-gris-12 text-lg py-2 px-4 cursor-pointer ease-in-out transition duration-300 border border-transparent hover:text-red-8 hover:bg-red-1 hover:border-red-6
