        ...
        <div className="pt-4 w-full h-[65vh] overflow-y-auto flex flex-col items-start justify-start gap-4 max-896:h-auto">
            ...
            <div className="border-b border-red-6 pb-4 w-full flex items-center justify-between gap-4">
                <div className="w-3/4 flex items-center">   
                    ...
                    <input id="code-promo" type="text" className="bg-gris-1 border border-red-4  block w-full text-gris-10 text-lg rounded-full outline-none focus:ring-red-7 focus:border-red-7 ps-4 p-1.5 placeholder:text-gris-6 max-896:text-sm" placeholder="Entrer le code promotionnelle" />                                        
                </div>
                <button className="cursor-pointer text-2xl text-red-8 hover:underline max-896:text-lg">Appliquer</button>
            </div>
            <div className="w-full flex items-center justify-between">
                <span className="text-2xl text-gris-12 font-bold max-896:text-lg">Réduction</span>
                <span className="text-2xl text-red-8 font-bold max-896:text-lg">0 FCFA</span>
            </div>
            <div className="w-full flex items-center justify-between">
