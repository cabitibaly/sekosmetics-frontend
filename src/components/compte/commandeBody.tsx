...
const CommandeBody = () => {
    ...
    return (
        <div className={`overflow-x-hidden px-[100px] pt-32 py-6 w-screen h-screen flex items-start justify-center gap-4 max-xl:px-[30px] max-896:flex-wrap max-896:!pb-4 max-896:!px-4 ${commandeId !== 0 ? "max-896:pt-10" : "max-896:pt-20"}`}>
                            ...
                            <div className="overflow-auto w-full flex flex-col items-center justify-start gap-3">
                                {
                                    commandes.map((commande) => (
                                        <CommandeCard
                                            ...
                                            date={new Date(commande.dateCreationCommande!).toLocaleDateString()}                                            
