                    ...
                    <form onSubmit={e => e.preventDefault()} className="w-full h-full flex flex-col items-center justify-start gap-4">
                        <div className="w-full flex flex-col items-start justify-center gap-4">
                            ...
                            <div className="relative w-full flex flex-col items-start gap-2">   
                                ...
                                <input id="ancien" type={isVisibleOld ? "text" : "password"} className="bg-gris-1 border border-red-4  block w-full text-gris-10 text-lg rounded-full outline-none focus:ring-red-7 focus:border-red-7 ps-4 p-2 placeholder:text-gris-6 max-896:text-base" placeholder="Mot de pass actuel..." />
                            ...
                            <div className="relative w-full flex flex-col items-start gap-2">   
                                ...
                                <input id="ancien" type={isVisibleNew ? "text" : "password"} className="bg-gris-1 border border-red-4  block w-full text-gris-10 text-lg rounded-full outline-none focus:ring-red-7 focus:border-red-7 ps-4 p-2 placeholder:text-gris-6 max-896:text-base" placeholder="Nouveau mot de passe..." />
