...
const MarqueDetailBody = ({id}: {id: string}) => {
    ...
    const { articles, refetch: refetchArticles, isFetchingNextPage, fetchNextPage, hasNextPage } = useGetLesArticlesPagine(8, categorieId || "", id, debouceValue.trim() || "", prixMin || "", prixMax || "");
